...
with tab1:    
        ...
        if submit_button and flag==0:
            ...
            import pickle
            with open(r"E:\\Vignesh\\model.pkl", 'rb') as file:
                loaded_model = pickle.load(file)
            with open(r'E:\\Vignesh\\scaler.pkl', 'rb') as f:
                scaler_loaded = pickle.load(f)

            with open(r"E:\\Vignesh\\t.pkl", 'rb') as f:
                t_loaded = pickle.load(f)

            with open(r"E:\\Vignesh\\s.pkl", 'rb') as f:
...
with tab2: 
        ...
        if csubmit_button and cflag==0:
            import pickle
            with open(r"E:\\Vignesh\\cmodel.pkl", 'rb') as file:
                cloaded_model = pickle.load(file)

            with open(r'E:\\Vignesh\\cscaler.pkl', 'rb') as f:
                cscaler_loaded = pickle.load(f)

            with open(r"E:\\Vignesh\\ct.pkl", 'rb') as f:
